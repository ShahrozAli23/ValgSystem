<%@ Page Language="VB" AutoEventWireup="false" CodeFile="showCandidate.aspx.vb" Inherits="showCandidate" %>
		...
		<div class="main main-raised">
			<div class="profile-content">
	            <div class="container">
                    ...
                    <div class="row">
                        <div class="profileLinks">
                            <div class="col-md-2 col-md-offset-3">
                                <i class="material-icons">phone</i> +45 31 38 23 23
                            </div>
                            <div class="col-md-2">
                                <i class="material-icons">home</i> <a href="#">www.hjemmeside.dk</a>
                            </div>
                            <div class="col-md-3">
                                <i class="material-icons">email</i> shahrozazmat@hotmail.com
                            </div>
                        </div>
                    </div>
                    <div class="row">
                    ...
                    <div class="row">
                        <div class="col-md-2 col-md-offset-5">
                            <button href="showCandidates.html" class="btn btn-primary btn-raised btn-round">
                                <i class="material-icons">arrow_back</i> Tilbage
                            </button>
                        </div>
	                </div>
