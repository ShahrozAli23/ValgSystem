        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6 col-md-offset-3">
                    <h1 class="title text-center">Opret Kandidat</h1>
                </div>
            </div>
        </div>
	</div>
	...
	<div class="main main-raised">
        <div class="section">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <h2 class="title">Opret ny kandidat <small>Hovedbestyrelsesvalg 2016</small></h2>
                    </div>
                    <div class="col-md-4">
                       ...
                       <div class="input-group">
                           ...
                           <input type="name" class="form-control" value="" placeholder="Indtast kandidatens email">
	                   </div>
                    <button class="btn btn-raised brn-primary"  type="submit" form="form1" value="Submit">Send Anmodning</button>
                    </div>
                </div>
            </div>
        </div>
